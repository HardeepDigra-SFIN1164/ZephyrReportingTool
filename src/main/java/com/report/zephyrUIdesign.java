...
public class zephyrUIdesign extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
		...
		//String[] receiverMail = jTextField6.getText().split(",");
        // WriteExcel.clearExcelData2();
       //  System.out.println("Input data: " + projectId + versionId + cycleName  + senderMail + receiverMail );
       try {
        	 ...
        	 ReadData.ExcelToHtml();
        	 SendMailWithHTMLContent sm  = new SendMailWithHTMLContent();
        	 String msg= sm.MessageOne();
        	 sm.sendEmail(msg,"Test Execution Status: " + (LocalDateTime.now().format(DateTimeFormatter.ofPattern("MMM dd, yyyy"))),receiverMail,senderMail);
// 		report_CycleName.combineDefectsDataPrint();
